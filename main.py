...
def game():
    ...
    while not done:
        ...
        if vector == -1:
            ...
            if len(snake) < 13:
                screen.blit(ff.render(u'Поражение!', 1, (250, 150, 120)), (100, 190))
            else:
                screen.blit(ff.render(u'Победа!', 1, (250, 150, 120)), (150, 190))
        else:
            pygame.time.delay(500)

        screen.blit(ff2.render(u'Управление клавишами <- и ->.', 1, (250, 250, 120)), (20, 450))
        screen.blit(ff2.render(u'Выйти - Esc.', 1, (250, 250, 120)), (500, 450))
        screen.blit(ff2.render(u'Для победы наберите 10 очков', 1, (120, 250, 120)), (350, 5))
        screen.blit(ff2.render(u'Очки: %s' % (len(snake)-3), 1, (120, 250, 120)), (15, 5))
...
def menu():
    ...
    while 1:
        ...
        screen.blit(menu_font.render(u'Начать игру - Enter', 1, (255, 200, 100)), (60, 150))
        screen.blit(menu_font.render(u'Выйти - Esc', 1, (255, 200, 100)), (150, 250))
...
if __name__ == '__main__':
    menu()
>>>>>>> cdc1d207577c0a6347c2e0d369893882ecf87154
